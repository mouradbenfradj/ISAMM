        ...
        <div class="art-blockcontent"><p><img width="190" height="142" alt="" src="images/artwork2.jpg" class=""></p><p><br></p><p><a href="#">voire plus&gt;&gt;</a></p></div>
                        ...
                        <div class="art-layout-cell art-content"><article class="art-post art-article">
                                <div class="art-postmetadataheader">
                                        <h2 class="art-postheader"><span class="art-postheadericon">emploie du temps de la class <?php $_SESSION['class']='test';if(isset($_POST['class'])){$_SESSION['class']=$_POST['class'];} echo $_SESSION['class']; ?></span></h2>
                                                            
                                    </div>
                                <div class="art-postcontent art-postcontent-0 clearfix"><table border="2">
                                <tr><td>j/h</td><td>lundi</td><td>mardi</td><td>mercredi</td><td>jeudi</td><td>vendredi</td><td>samedi</td></tr>
