        ...
        <div class="art-blockcontent"><p><img width="190" height="142" alt="" src="images/artwork2.jpg" class=""></p><p><br></p><p><a href="#">voire plus&gt;&gt;</a></p></div>
                        ...
                        <div class="art-layout-cell art-content"><article class="art-post art-article">
                                <div class="art-postmetadataheader">
                                        <h2 class="art-postheader"><span class="art-postheadericon"><?php if(isset($_GET['af'])){echo $_GET['af'];}else{echo $_POST['tab'];}?></span></h2>
                                                            
                                    </div>
                                <div class="art-postcontent art-postcontent-0 clearfix"><p><?php include('fonction.php'); 
								if(isset($_GET['af'])){
								afficher($_GET['af']);
								}
								elseif(isset($_POST['identm'])){supprimer($_POST['identm'],$_POST['tab']);}
								elseif(isset($_POST['idents'])){supprimer($_POST['idents'],$_POST['tab']);}
								?> </p></div>
